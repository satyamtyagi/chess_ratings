...
def build_opdn(ordered, players):
    """Counts-based OPDN: single sweep, unit step (no LR), then recenter."""
    pairs, n_players = aggregate_pairs(ordered, players)
    # expects one_pass_opdn_counts to be defined elsewhere in this file
    theta = one_pass_opdn_counts(pairs, n_players, init=None, ridge=0.0, step_cap=None, recenter=True)
